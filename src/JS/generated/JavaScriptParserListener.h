...
public:
  ...
  virtual void enterImportModuleItems(JavaScriptParser::ImportModuleItemsContext *ctx) = 0;
  virtual void exitImportModuleItems(JavaScriptParser::ImportModuleItemsContext *ctx) = 0;

  virtual void enterImportAliasName(JavaScriptParser::ImportAliasNameContext *ctx) = 0;
  virtual void exitImportAliasName(JavaScriptParser::ImportAliasNameContext *ctx) = 0;

  virtual void enterModuleExportName(JavaScriptParser::ModuleExportNameContext *ctx) = 0;
  virtual void exitModuleExportName(JavaScriptParser::ModuleExportNameContext *ctx) = 0;

  virtual void enterImportedBinding(JavaScriptParser::ImportedBindingContext *ctx) = 0;
  virtual void exitImportedBinding(JavaScriptParser::ImportedBindingContext *ctx) = 0;
  ...
  virtual void enterExportModuleItems(JavaScriptParser::ExportModuleItemsContext *ctx) = 0;
  virtual void exitExportModuleItems(JavaScriptParser::ExportModuleItemsContext *ctx) = 0;

  virtual void enterExportAliasName(JavaScriptParser::ExportAliasNameContext *ctx) = 0;
  virtual void exitExportAliasName(JavaScriptParser::ExportAliasNameContext *ctx) = 0;
  ...
  virtual void enterPrivateIdentifier(JavaScriptParser::PrivateIdentifierContext *ctx) = 0;
  virtual void exitPrivateIdentifier(JavaScriptParser::PrivateIdentifierContext *ctx) = 0;
  ...
  virtual void enterNamedFunction(JavaScriptParser::NamedFunctionContext *ctx) = 0;
  virtual void exitNamedFunction(JavaScriptParser::NamedFunctionContext *ctx) = 0;
