...
public:
  ...
  virtual void enterVariableDeclarator(JavaScriptParser::VariableDeclaratorContext *ctx) = 0;
  virtual void exitVariableDeclarator(JavaScriptParser::VariableDeclaratorContext *ctx) = 0;
  ...
  virtual void enterClassElementName(JavaScriptParser::ClassElementNameContext *ctx) = 0;
  virtual void exitClassElementName(JavaScriptParser::ClassElementNameContext *ctx) = 0;
  ...
  virtual void enterYieldStarExpression(JavaScriptParser::YieldStarExpressionContext *ctx) = 0;
  virtual void exitYieldStarExpression(JavaScriptParser::YieldStarExpressionContext *ctx) = 0;

  virtual void enterOptionalMemberDotExpression(JavaScriptParser::OptionalMemberDotExpressionContext *ctx) = 0;
  virtual void exitOptionalMemberDotExpression(JavaScriptParser::OptionalMemberDotExpressionContext *ctx) = 0;
  ...
  virtual void enterOptionalCallExpression(JavaScriptParser::OptionalCallExpressionContext *ctx) = 0;
  virtual void exitOptionalCallExpression(JavaScriptParser::OptionalCallExpressionContext *ctx) = 0;
  ...
  virtual void enterOptionalMemberIndexExpression(JavaScriptParser::OptionalMemberIndexExpressionContext *ctx) = 0;
  virtual void exitOptionalMemberIndexExpression(JavaScriptParser::OptionalMemberIndexExpressionContext *ctx) = 0;
  ...
  virtual void enterMethodAssignment(JavaScriptParser::MethodAssignmentContext *ctx) = 0;
  virtual void exitMethodAssignment(JavaScriptParser::MethodAssignmentContext *ctx) = 0;

  virtual void enterGeneratorMethodAssignment(JavaScriptParser::GeneratorMethodAssignmentContext *ctx) = 0;
  virtual void exitGeneratorMethodAssignment(JavaScriptParser::GeneratorMethodAssignmentContext *ctx) = 0;

  virtual void enterGetterAssignment(JavaScriptParser::GetterAssignmentContext *ctx) = 0;
  virtual void exitGetterAssignment(JavaScriptParser::GetterAssignmentContext *ctx) = 0;

  virtual void enterSetterAssignment(JavaScriptParser::SetterAssignmentContext *ctx) = 0;
  virtual void exitSetterAssignment(JavaScriptParser::SetterAssignmentContext *ctx) = 0;

  virtual void enterSpreadAssignment(JavaScriptParser::SpreadAssignmentContext *ctx) = 0;
  virtual void exitSpreadAssignment(JavaScriptParser::SpreadAssignmentContext *ctx) = 0;
