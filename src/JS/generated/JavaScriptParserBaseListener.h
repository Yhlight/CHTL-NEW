...
// Generated from src/ThirdParty/Grammars/JavaScript/JavaScriptParser.g4 by ANTLR 4.13.2
...
public:
  ...
  virtual void enterImportModuleItems(JavaScriptParser::ImportModuleItemsContext * /*ctx*/) override { }
  virtual void exitImportModuleItems(JavaScriptParser::ImportModuleItemsContext * /*ctx*/) override { }

  virtual void enterImportAliasName(JavaScriptParser::ImportAliasNameContext * /*ctx*/) override { }
  virtual void exitImportAliasName(JavaScriptParser::ImportAliasNameContext * /*ctx*/) override { }

  virtual void enterModuleExportName(JavaScriptParser::ModuleExportNameContext * /*ctx*/) override { }
  virtual void exitModuleExportName(JavaScriptParser::ModuleExportNameContext * /*ctx*/) override { }

  virtual void enterImportedBinding(JavaScriptParser::ImportedBindingContext * /*ctx*/) override { }
  virtual void exitImportedBinding(JavaScriptParser::ImportedBindingContext * /*ctx*/) override { }
  ...
  virtual void enterExportModuleItems(JavaScriptParser::ExportModuleItemsContext * /*ctx*/) override { }
  virtual void exitExportModuleItems(JavaScriptParser::ExportModuleItemsContext * /*ctx*/) override { }

  virtual void enterExportAliasName(JavaScriptParser::ExportAliasNameContext * /*ctx*/) override { }
  virtual void exitExportAliasName(JavaScriptParser::ExportAliasNameContext * /*ctx*/) override { }
  ...
  virtual void enterPrivateIdentifier(JavaScriptParser::PrivateIdentifierContext * /*ctx*/) override { }
  virtual void exitPrivateIdentifier(JavaScriptParser::PrivateIdentifierContext * /*ctx*/) override { }
  ...
  virtual void enterNamedFunction(JavaScriptParser::NamedFunctionContext * /*ctx*/) override { }
  virtual void exitNamedFunction(JavaScriptParser::NamedFunctionContext * /*ctx*/) override { }
